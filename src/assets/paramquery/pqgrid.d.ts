  ...
  namespace gridT {
    ...
    interface SelectRow {
      add(obj: {
        rowIndx?: number;
        isFirst?: boolean;
        rows?: { rowIndx?: number; rowIndxPage?: number }[];
      });
    ...
    interface instance {
      ...
      commit(obj?: { type?: string; rows?: any[] });

      copy();

      createTable(obj: { $cont: JQuery; data: any[] });

      data(obj: { rowData; rowIndx; dataIndx; data });
      ...
      flex(obj?: { dataIndx?: Array<numberorstring>; colIndx?: Array<number> });

      focus(obj?: { rowIndxPage: number; colIndx: number });
      ...
      getCellIndices({$td: JQuery}): cellObject;
      ...
      reset(obj: { filter?: boolean; group?: boolean; sort?: boolean });
      ...
      scrollColumn(
        obj: { colIndx?: number; dataIndx?: numberorstring },
        fn?: () => void
      );

      scrollRow(
        obj: { rowIndxPage?: number; rowIndx?: number },
        fn?: () => void
      );
