...
function(t) {
    ...
    o._create = function() {
        ...
        var f = e.$grid_center = t(".pq-grid-center", r).on("scroll", function() {
            ...
            p = e.$header = t(".pq-header-outer", f).on("scroll", function() {
        ...
        f.on("mousedown", e._onGCMouseDown.bind(e)), e.iRenderB = new pq.cRenderBody(e, {
            ...
            colModel: e.colModel
        }), "ontouchend" in document && (e.addTouch(), e.contextIOS(r)), r.on("contextmenu", e.onContext.bind(e)), g.on("click", ".pq-grid-cell,.pq-grid-number-cell", function(n) {
    ...
    a.refreshCM = function(t, e) {
        ...
        if (void 0 === x && "function" == typeof c.geditor && (x = c.geditor.call(y, w)), x !== !1) {
            ...
            var D = M.children(".pq-editor-focus"),
                X = u.filterKeys,
                Q = g.editModel;
            Q && void 0 !== Q.filterKeys && (X = Q.filterKeys);
            var Y = {
                $cell: M,
                $editor: D,
    ...
    n.prototype = t.extend({
        ...
        pic: function(t, e, n) {
            var r = this,
                ...
                o = 0,
                a = 0;
            r.each(function(t, e, n, r, i, l) {
                return o = i, a = l, !1
            }), pq.fileToBase(t, function(r) {
                i.Pic().add(t.name, r, [a, e || 0, o, n || 0])
            })
        },
                ...
                for (v = 0; E > v; v++) {
                    ...
                    for (S = k, U = 0; S > U; U++) {
                        ...
                        var G = U + w,
                            ...
                            X = j[z],
                            Q = K.dataIndx;
                        K.copy !== !1 ? (z++, N[Q] = X, L && (L[Q] = u(V, K))) : (W++, "extend" == T && g > S + w && S++)
                    }
...
function(t) {
    ...
    var r = n.cGroup = function(t) {
        ...
        e.model = "groupModel", e.cbId = n.cbId, e.childstr = n.childstr, e.id = n.id, e.parentId = n.parentId, e.cache = {}, e.prop = "pq_group_prop", e.that = t, Object.defineProperty(n, "nodeClose", {
            get: function() {
                return e.fillState({})
            },
            set: function(t) {
...
function(t) {
    ...
    n.prototype = {
        ...
        onclickDoc: function(t) {
            ...
            r && (r.disabled || (n = r.action,
                n && (e = n.call(this.that, t, this.ui, r), e !== !1 && this.removeMenu())))
        },
        ...
        showMenu: function(e, n) {
            var r, i = this,
                ...
                u = n.type,
                h = u + "Items",
                f = a[h] || (u ? a.items : a.miscItems),
                f = "function" == typeof f ? f.call(d, e, n) : f;
            return c && i.removeMenu(), f && f.length && a.preInit.call(d, e, n) !== !1 ? (a.init.call(d, e, n), i.ui = n, c = i.$menu = i.createMenu(f), r = l.offset(), c.position({
                my: (o ? "right" : "left") + " top",
                at: "left+" + (e.pageX - r.left) + " top+" + (e.pageY - r.top),
                of: l,
                collision: "flipfit"
            }), t(document.body).on("click" + s, i.onclickDoc.bind(i)).on("mousedown" + s + " touchstart" + s, i.onMouseDown.bind(i)), !1) : void 0
        }
    }
}(jQuery),
function(t) {
...
function(t) {
    ...
    var n = e.cTree = function(t) {
        var e = this;
        e.model = "treeModel", e.that = t, e.fns = {}, e.init(), e.cache = {}, e.di_prev, e.chkRows = [], Object.defineProperty(t.options.treeModel, "nodeClose", {
            get: function() {
                return e.fillState({})
            },
            set: function(t) {
    ...
    pq.excelImport = {
        ...
        getWorkSheet: function(t, e, n, r, i) {
            ...
            for (H.forEach(function(t, e) {
                ...
                c = {
                    cells: []
                }, b = $[O], w = D.attr(b), _ = w.r, f = w.s, q = f ? D.getStyle(f) : {};
                for (o in q) c[o] = q[o];
        ...
        readPaths: function() {
            var e, n = this.files,
                r = t(t.parseXML(n["[Content_Types].xml"].asText())),
                i = this.paths = {
                    wb: "sheet.main",
                    ws: "worksheet",
                    st: "styles",
            ...
            for (e in i) i[e] = r.find('[ContentType$="' + i[e] + '+xml"]').attr("PartName");
            for (e in n)
    ...
    r.prototype = t.extend({
        ...
        getXlsBody: function(n, r, i, o, a, l, s, d, c, u, h) {
            ...
            for (p = 0; o > p; p++) {
                ...
                E = {}, q.length && (E.cells = q), D.pq_hidden && (E.hidden = !0), j.copyStyle(E, D.pq_rowstyle, D.pq_rowprop), h && (H = (h.call(B, y) || {}).style, H && j.copyStyle(E, H)), pq.isEmpty(E) || (z.length !== p && (E.indx = p), z.push(E))
            }
            return z
        },
    ...
    var e = pq.excel = {
        ...
        exportWb: function(t) {
            var e = t.workbook,
                ...
                u = {},
                h = c.folder("xl");
            return c.file("_rels/.rels", o.rels), c.file("xl/_rels/workbook.xml.rels", r.getWBookRels(l)), a.forEach(function(t, e) {
                var o, a, l = r.getCols(t.columns),
                    c = t.pics || [],
                    f = c.length,
                    p = e + 1,
                    g = r.getFrozen(t.frozenRows, t.frozenCols, t.rtl),
                    v = r.getBody(t.rows, t.columns),
                    m = r.getMergeCells(t.mergeCells);
                i.push(t.name), n && (v = v.replace.apply(v, n)), o = r.comments, a = !pq.isEmpty(o), h.file("worksheets/sheet" + p + ".xml", r.getSheet(g, l, v, m, a, f, p)), a && (s.push(p), h.file("comments" + p + ".xml", r.getComment()), h.file("drawings/vmlDrawing" + p + ".vml", r.getVml())), f && (r.addPics(h, c, p), c.forEach(function(t) {
                    u[t.name.split(["."])[1]] = 1
                }), d.push(p)), (a || f) && h.file("worksheets/_rels/sheet" + p + ".xml.rels", r.getSheetRel(p, a, f))
            }), c.file("[Content_Types].xml", r.getContentTypes(l, s, d, u)), h.file("workbook.xml", r.getWBook(i)), h.file("styles.xml", r.getStyle()), t.url ? (t.data = c.generate({
                type: "base64",
                compression: "DEFLATE"
            }), t.decodeBase = !0, pq.postRequest(t)) : c.generate({
                type: t.type || "blob",
                compression: "DEFLATE"
            })
        },
